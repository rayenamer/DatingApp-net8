...
) : BaseApiController
{
    ...
    [HttpPost("add-photo")]
    public async Task<ActionResult<PhotoDto>> 
    AddPhoto(IFormFile file)
    {
        var user = await userRepository
        .GetUserByUsernameAsync(User.GetUserName());
    ...
    public async Task<ActionResult> SetMainPhoto(int photoId)
    {
        ...
        if(photo == null || photo.IsMain) 
            return BadRequest("Cannot us this as main");
    ...
    public async Task<ActionResult> DeletePhoto(int photoId)
    {
        ...
        if(photo == null || photo.IsMain) return BadRequest("cannot be deleted");
